...
const CodeBlock: FC<Props> = memo(({ language, value }) => {
  ...
  return (
    <div className="codeblock relative w-full bg-neutral-800 font-sans">
      <div className="flex w-full items-center justify-between bg-neutral-700 px-6 py-1 pr-4 text-zinc-100">
