...
export type VideoSearchResultsProps = {
            ...
            <div className="py-4">
              ...
              >
                ...
                <div className="pointer-events-none absolute inset-8 flex items-center justify-between p-4">
                  <CarouselPrevious className="pointer-events-auto size-10 rounded-full shadow focus:outline-none">
                    <span className="sr-only">Previous</span>
                  </CarouselPrevious>
                  <CarouselNext className="pointer-events-auto size-10 rounded-full shadow focus:outline-none">
